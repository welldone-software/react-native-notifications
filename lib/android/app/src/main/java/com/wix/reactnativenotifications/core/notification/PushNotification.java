...
import com.wix.reactnativenotifications.core.NotificationActionService;
    ...
    private void setActions(Notification.Builder notification) {
        ...
        if (actionsArray != null) {
            for (int i = 0; i < actionsArray.length(); i++) {
                ...
                Intent actionIntent = new Intent(mContext.getApplicationContext(), NotificationActionService.class);
